...
export const RRRTXLogo: React.FC<LogoProps> = ({ 
  ...
  const IconMark = () => (
    <svg viewBox="0 0 100 100" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Background Frame (Optional for Icon variant) */}
      <rect width="100" height="100" rx="20" fill={isLight ? "#F5F5F5" : "#0F0F0F"} />
      
      {/* Precision Grid Lines (Subtle) */}
      ...
      <path d="M35 25H55C65 25 70 30 70 40C70 50 65 55 55 55H35" stroke={iconColor} strokeWidth="8" strokeLinejoin="square" />
